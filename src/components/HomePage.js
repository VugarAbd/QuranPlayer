...
import RecitersMenu from './RecitersMenu'
  ...
  return (
    <div className='row p-5 home-body '>
      <div className='col-lg-4 col-md-4 col-sm-12 col-12 scroll'>
        <RecitersMenu reciters={reciters} reciterHandler={reciterHandler} />
      </div>
      <div className='col-lg-4 col-md-4 col-sm-12 col-12 scroll '>
        <ChaptersMenu chapters={chapters} chapterHandler={chapterHandler} />
      </div>
